<template>
  <el-card>
    ...
    <div class="searchButton">
      ...
      <el-button type="primary" size="default" @click="expandAllRow">
        展开/折叠
      </el-button>
    </div>
    ...
    >
      ...
      >
        <el-form-item label="类型" prop="type">
          <el-radio-group v-model="menuData.type">
            <el-radio
              border
              v-show="
                (!menuData.id && (!addMenuType || addMenuType === 1)) ||
                (menuData.id > 0 && menuData.type === 1)
              "
              :label="1"
            >
              菜单
            ...
            <el-radio
              border
              v-show="
                (!menuData.id && (!addMenuType || addMenuType === 2)) ||
                (menuData.id > 0 && menuData.type === 2)
              "
              :label="2"
            >
              按钮
        ...
        <el-form-item label="菜单名称" prop="menuName">
          <el-input
            :placeholder="
              menuData.type === 1 ? '请输入菜单名称' : '请输入按钮名称'
            "
