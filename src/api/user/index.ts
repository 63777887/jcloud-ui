//统一管理咱们项目用户相关的接口
import type {LoginFormData, LoginResponseData, CheckTokenResponseData,} from './type'
...
export const reqLogin = async (data: LoginFormData): Promise<LoginResponseData> => {
    ...
    return await authRequest.post<any, LoginResponseData>(API.LOGIN_URL + "?grant_type=password&scope=CSJS,server", formData, {
        headers: {
